      ...
      flipLeft(true)
{
    ...
    for (int y = 0; y < height; ++y)
    {
        ...
        for (int x = 0; x < width; ++x)
        {
            ...
            switch (y)
            {
            case 0: item->setPixmap(QPixmap(":/images/start.png")); break;
            case 1: item->setPixmap(QPixmap(":/images/settings.png")); break;
            case 2: item->setPixmap(QPixmap(":/images/quit.png")); break;
